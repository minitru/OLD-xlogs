...
FROM stats_country_iso_codes AS c, user_table AS ut, blogroar_blogtable AS bt,blogroar_keygen AS bk, blogroar_shareblog AS sb
...
FROM stats_country_iso_codes AS c, visit_stats AS vs, blogroar_blogtable AS bt,blogroar_keygen AS bk, blogroar_shareblog AS sb
