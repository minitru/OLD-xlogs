...
FROM  user_table AS ut, blogroar_blogtable AS bt,blogroar_keygen AS bk, blogroar_shareblog AS sb
...
FROM  visit_stats AS vs, blogroar_blogtable AS bt,blogroar_keygen AS bk, blogroar_shareblog AS sb
